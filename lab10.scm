...
(define (teacher-hold-class teacher)
  ...
  (define attendance (map (lambda (student) (student-attend-class student class)) (teacher-get-students teacher)))

  (teacher-create (teacher-get-name teacher) class attendance)
)
